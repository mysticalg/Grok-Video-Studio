...
class FilteredWebEnginePage(QWebEnginePage):
    ...
    _IGNORED_CONSOLE_PATTERNS = (
        ...
        "Permissions-Policy header: Unrecognized feature: 'otp-credentials'",
        "Permissions-Policy header: Unrecognized feature: 'payment'",
        "Permissions-Policy header: Unrecognized feature: 'usb'",
        "Permissions policy violation: unload is not allowed in this document",
        "violates the following Content Security Policy directive",
        "Play failed: [object DOMException]",
        "[object DOMException]",
        "Reflect is already polyfilled",
        "AppContext will be overwritten",
        "loadableReady() requires state",
        ...
        "config must be use after function init",
